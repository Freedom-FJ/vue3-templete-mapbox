 ...
 * @LastEditors: mjh
 * @LastEditTime: 2022-10-09 16:31:24
 * @Description:
-->
<template lang="pug">
commonPanel(title="降雨预报"  panelBg='panel-big' :height='224' :bigBgTop="14")
...
import { rainfallForecastChartOption } from '@/utils/echarts/echartsOptions'
...
onMounted(async () => {
    ...
    const option = rainfallForecastChartOption(xAxis, seriesData)
    console.log(option)
